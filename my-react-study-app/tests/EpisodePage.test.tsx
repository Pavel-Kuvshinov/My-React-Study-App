...
import { mockCharactersData, mockEpisodesData } from '@/shared/mocks/mockedData/cards';
...
beforeEach(() => {
    ...
    (useLoaderData as Mock).mockReturnValue({
        ...
        idItem: 21,
        dataItem: mockEpisodesData.results[0],
    });
});
    ...
    it('Here should be Episode page', () => {
        ...
        render(
            <Provider store={store}>
                <ThemeProvider>
                    <MemoryRouter initialEntries={['/episode?page=2&name=&id=21']}>
                        <Episode />
                    </MemoryRouter>
                </ThemeProvider>
            </Provider>
