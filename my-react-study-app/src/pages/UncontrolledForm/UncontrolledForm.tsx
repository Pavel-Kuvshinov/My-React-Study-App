				...
				<div className='form__wrapper'>
					<form className='uncontrolledForm' onSubmit={handleSubmit} onChange={handleChangeForm}>
						...
						<div className='input__wrapper column'>
							...
							<input name={FormFieldsNames.Age} className='input__text'  id='age-input' type='number'></input>
							<p className='input__error'>{ errors.age ? errors.age.message : ''}</p>
						</div>
						<div className='input__wrapper column'>
							<label className='input__label' htmlFor='email-input'>E-mail</label>
							<input name={FormFieldsNames.Email} className='input__text' id='email-input' type='email'></input>
						...
						<div className='input__wrapper column'>
							...
							<input name={FormFieldsNames.ConfirmPassword} className='input__text' id='confirm-password-input' type='password'></input>
						...
						<div className='input__wrapper column'>
							...
							<select name={FormFieldsNames.Gender} className='input__text' defaultValue="" id='gender-input'>
