                    ...
                    return (
                        <React.Fragment key={fieldName}>
                            ...
                            <div className="data_table__cell">
                                {uncontrolledFormData[fieldName] ? (
                                    fieldName === FormFieldsNames.Picture ? (
                                        <img
                                            className="data_table__cell_image"
                                            src={uncontrolledFormData[fieldName] as string}
                                            alt="img"
                                        />
                                    ) : uncontrolledFormData[fieldName] === 'on' ? (
                                        '✅'
                                    ) : (
                                        uncontrolledFormData[fieldName]
                                    )
                            ...
                            <div className="data_table__cell">
                                {reactHookFormData[fieldName] ? (
                                    fieldName === FormFieldsNames.Picture ? (
                                        <img
                                            className="data_table__cell_image"
                                            src={reactHookFormData[fieldName] as string}
                                            alt="img"
                                        />
                                    ) : reactHookFormData[fieldName] === true ? (
                                        '✅'
                                    ) : (
                                        reactHookFormData[fieldName]
                                    )
